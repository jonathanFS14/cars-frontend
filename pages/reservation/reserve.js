...
import { sanitizeStringWithTableRows, makeOptionsToken } from "../../../utils.js"
...
export async function initReservation() {
  ...
  carReservationDateEnd = document.getElementById("reservation-date-end")
...
async function reserveCar() {
  ...
  const reservationRequest = {
    ...
    reservationDateStart : carReservationDate.value,
    reservationDateEnd : carReservationDateEnd.value
  }
  const fetchOptions = makeOptionsToken("POST", reservationRequest, true)
  try {
